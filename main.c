...
int main() {
  printf("Hello World!\n");
  printf("Corb I don't know how to write in C, all I know is COBOL.\n\n");
  ...
  printf("⠀⠀⠀⠀⠀⢿⣿⣦⣄⣀⣠⣴⣿⣿⠁⠀⠈⠻⣿⣿⣿⣿⡿⠏⠀⠀⠀⠀\n");
  printf("⠀⠀⠀⠀⠀⠈⠛⠻⠿⠿⠿⠿⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n");
  printf("ah Corbin look Among Us.\n\n");

  // Corb on the Cob ASCII Art
  printf("        ,--.\n");
  printf("       ( o  )\n");
  printf("      /|--|\\\n");
  printf("     /_|__|_\\\n");
  printf("      ||  ||     CORB ON THE COB\n");
  printf("     /_|__|_\\    ~ majestic, crunchy, proud ~\n");
  printf("    //||||||\\\\\n");
  printf("   ||||||||||||\n");
  printf("   ||||||||||||\n");
  printf("   ||||||||||||\n");
  ...
  // Print CORB lines (shortened for sanity)
  for (int i = 0; i < 20; i++) {
    printf("CORB #%d\n", i + 1);
  }

  printf("\nI have printed CORB 20 times.\n");
  printf("Was it useful? No.\n");
  printf("Was it beautiful? Absolutely.\n");
  printf("Goodbye.\n\n");

  // Corb's thoughts
  const char *thoughts[] = {"Is corn just grass with ambition?",
  ...
  for (int i = 0; i < 10; i++) {
    ...
    // sleep(1000); // wait 1 second (Windows)
  }
...
//
// 6767676767676767676767676767676767676767676767676767676767676767676767676767676767676767676767676767676767676767676767
// main
